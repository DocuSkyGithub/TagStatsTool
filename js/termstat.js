		...
		for(i = 0, li = docuSkyObj_doc.docList.length; i < li; i++){
         ...
         //alert(JSON.stringify(tmp_filemeta));
            ...
            if (paragraphs.length !== 0 && paragraphAsDoc) {         // 2018-06-29: add paragraphAsDoc check
               // 2019-06-15: 將 CatTree, MetaTags, Comment, Events 也視為個別 Paragraph 來計算
               paragraphs = parsedxml.querySelectorAll("Content>Paragraph, Content>CatTree, Content>MetaTags, Content>Comment, Content>Events");
